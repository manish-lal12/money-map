    ...
    <header className={cn("border-b border-border", className)}>
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="#" className="text-sm font-medium hover:text-finance-blue transition-colors">Expenses</a>
          <a href="#" className="text-sm font-medium hover:text-finance-blue transition-colors">Tax Planner</a>
          <a href="#" className="text-sm font-medium hover:text-finance-blue transition-colors">Investments</a>
        </nav>
